...
Walk in. Reserve a table. Bring everyone.`,
  ...
  testimonials: {
    enabled: true,
    heading: 'Loved by Seattle',
    items: [
      {
        quote: 'The waterfront view at Alki and a grill full of premium short rib — date night doesn\'t get better than this.',
        author: 'Maya R.',
        role: 'Google · 5★',
        rating: 5,
        source: 'google',
      ...
      {
        quote: 'AYCE Supreme is unreal. The wagyu cuts alone are worth it. We came as a group of six and couldn\'t finish.',
        author: 'Daniel K.',
        role: 'Yelp Elite',
        rating: 5,
        source: 'yelp',
      ...
      {
        quote: 'Big group dinner energy from the moment you sit down. The banchan keeps coming. The grill keeps going.',
        author: 'Featured · Eater Seattle',
        role: 'Press',
        rating: null,
        source: 'press',
        photoUrl: null,
  ...
  gallery: {
    enabled: false,
    heading: 'Inside Do Si',
    description: 'Tabletop grills, the Alki waterfront, and a banchan spread you\'ll remember.',
    photos: [],
  },
  social: {
