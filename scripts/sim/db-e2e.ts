...
async function main() {
  ...
  try {
    ...
    if (mintCampaignId) {
      ...
      const saved: SavedCampaign = { clientId: TEST_CLIENT, draft, phase: 'build', status: 'draft', shippedAt: null, createdAt: now, updatedAt: now, creatorChoices: {}, creativeControl: 'handoff' }
