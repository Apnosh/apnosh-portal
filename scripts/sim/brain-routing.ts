...
const GOLDEN: Record<string, Golden> = {
  ...
  richConnected: {
    ...
    mixes: {'firstvisit/lean': ['gbp-setup', 'site-menu', 'review-engine', 'street-sampling', 'friend-hook'], 'firstvisit/standard': ['gbp-posts', 'photo-library', 'gbp-setup', 'site-menu', 'review-engine', 'landing-page', 'local-seo', 'crm-list', 'social-mgmt', 'tracking', 'creator-monthly', 'lto-launch', 'street-sampling', 'creator-collab', 'friend-hook', 'ordering-setup', 'ugc-rights', 'google-food-order'], 'firstvisit/aggressive': ['gbp-posts', 'photo-library', 'email-found', 'gbp-setup', 'site-menu', 'welcome-seq', 'review-engine', 'review-responses', 'video-engine', 'landing-page', 'local-seo', 'crm-list', 'social-mgmt', 'tracking', 'listings-sync', 'creator-monthly', 'paid-ads', 'concierge', 'lto-launch', 'menu-photo-refresh', 'street-sampling', 'creator-collab', 'friend-hook', 'ordering-setup', 'ai-phone', 'ugc-rights', 'google-food-order', 'referral'], 'nights/lean': ['sms-found', 'gbp-posts', 'sms-program', 'crm-list', 'tracking', 'event-pkg'], 'nights/standard': ['sms-found', 'gbp-posts', 'sms-program', 'crm-list', 'tracking', 'reporting', 'event-pkg', 'lto-launch', 'reminder-send', 'bar-events', 'menu-eng'], 'nights/aggressive': ['sms-found', 'gbp-posts', 'sms-program', 'loyalty', 'crm-list', 'tracking', 'reporting', 'seasonal-cal', 'event-pkg', 'lto-launch', 'reminder-send', 'bar-events', 'reservation-protect', 'menu-eng', 'paid-ads'], 'regulars/lean': ['winback', 'sms-found', 'crm-list', 'welcome-seq', 'incentive-design', 'tracking', 'email-found', 'reminder-send'], 'regulars/standard': ['winback', 'newsletter', 'sms-found', 'crm-list', 'loyalty', 'welcome-seq', 'birthday', 'review-engine', 'incentive-design', 'sms-program', 'tracking', 'email-found', 'feedback-loop', 'reporting', 'referral', 'reminder-send', 'menu-eng', 'ugc-rights'], 'regulars/aggressive': ['winback', 'newsletter', 'sms-found', 'crm-list', 'loyalty', 'welcome-seq', 'birthday', 'review-engine', 'incentive-design', 'sms-program', 'tracking', 'email-found', 'feedback-loop', 'seasonal-cal', 'reporting', 'referral', 'vip-comms', 'reminder-send', 'menu-eng', 'bar-events', 'giftcards', 'ugc-rights'], 'reviews/lean': ['review-engine', 'review-responses', 'gbp-setup', 'review-claim', 'feedback-loop'], 'reviews/standard': ['review-engine', 'review-responses', 'gbp-setup', 'review-claim', 'feedback-loop', 'photo-library', 'menu-photo-refresh', 'staff-advocacy'], 'reviews/aggressive': ['review-engine', 'review-responses', 'gbp-setup', 'review-claim', 'feedback-loop', 'listings-sync', 'photo-library', 'menu-photo-refresh', 'staff-advocacy']},
    fits: {'welcome-seq': 30, 'review-engine': 15, 'review-responses': 15},
  },
  gbpOnly: {
