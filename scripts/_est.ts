...
;(async () => {
  ...
  // Seattle, city type, 5 mile radius
  const r = await fetch(`${HOST}/api/dashboard/ads`, {
    method: 'POST', headers: { 'Content-Type': 'application/json', cookie },
    body: JSON.stringify({ clientId: c!.id, action: 'estimate', adPlatform: 'meta',
      targeting: { geoKey: '2542527', geoType: 'city', radiusMiles: 5, ageMin: 18, ageMax: 65 } }),
  })
