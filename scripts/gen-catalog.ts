 ...
 */
import { rowToService, type CatalogRow } from '../src/lib/campaigns/data/catalog-db-shape'
...
async function main() {
  ...
  const out = `/* AUTOGENERATED from the catalog_services table by scripts/gen-catalog.ts. DO NOT EDIT BY HAND.
 * Regenerate with \`npx tsx scripts/gen-catalog.ts\` (or the admin Publish). ${services.length} active services. */
/* eslint-disable */
