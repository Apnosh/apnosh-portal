...
const spec = (
  ...
  extra: Partial<Pick<JobSpec, 'headline' | 'asks' | 'timing' | 'scope' | 'voice' | 'format'>> = {},
...
export const JOB_REGISTRY: readonly JobSpec[] = [
  ...
  spec('story-behind', 'brand', '👋', { format: 'carousel', headline: 'The Story Behind Us', asks: ['subject'], voice: { blurb: 'The post that tells people who you are and why you started.', ask: 'Pick the story you want to tell. Then answer a few easy questions.', angles: [
