...
export const DESIGN_SUBS: Record<string, string> = {
  job: 'Say it like a text to your designer. We take it from there.',
...
export const DESIGN_LINES: Record<string, string> = {
  ...
  'dest.somewhere.pick': 'Tell us the spot below',
  'when.quick.standard': 'Standard',
  'when.quick.event': 'Before your event',
  'when.quick.day': 'Pick a day',
  'when.quick.day.sub': 'Open the calendar',
  'when.eventclose': 'Your event on {date} is close. Pick the day you need it in hand.',
  'photos.yours': 'Your photos',
  'photos.pickedn': '{n} picked',
  'photos.source.short': 'We find photos',
  ...
  'brand.strip': 'On file',
  'brand.mode.file': 'My brand',
  'brand.mode.custom': 'Different',
  'brand.mode.none': 'No kit',
  'brand.addlogo': 'Add logo',
  'brand.addcolor': 'Add a color',
  'brand.editcolor': 'Change this color',
  'brand.kit.note': 'Saved to your account. Every order carries it.',
  'brand.saving': 'Saving to your account',
  'brand.files.add': 'Add files',
  'brand.files.note': 'These files go with this order only.',
