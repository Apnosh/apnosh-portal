...
export const CAMPAIGN_CONTENT: Record<CreateCatalogId, CampaignContent> = {
  ...
  deliverymenu: {
    ...
    tagline: "Stop losing money on every delivery order",
    description: "Every dish repriced for the delivery apps, worked out from your own menu and the cut they take, plus the ones to pull off entirely.",
    promise: "The right price for every dish on the apps, and the list of dishes that should not be on there.",
    why: "The apps take 15 to 30 cents of every dollar. Most menus were priced for the dining room and never redone, so the busier delivery gets, the worse it pays.",
    expectation: "Delivery will still earn less per plate than your dining room. This makes sure it earns something.",
    heroImage: null,
  },
  loyalty: {
    id: 'loyalty',
    title: "Start a loyalty program",
    tagline: "Turn first visits into regulars, on points or punches",
    description: "A loyalty program picked to fit how you sell, wired into your till, with digital punch or points cards your guests actually carry.",
    promise: "The right loyalty program picked, set up, and wired into how you already ring people up.",
    why: "Your regulars already exist. A program gives them a reason to come one more time a month, and that one visit is where the money is.",
    expectation: "Loyalty pays off over months, not days. The habit builds slowly and then it is your floor.",
    heroImage: null,
  },
  gbpmgmt: {
    id: 'gbpmgmt',
    title: "Keep your Google profile active",
    tagline: "Weekly posts, fresh photos, questions answered",
    description: "Your Google profile kept alive month to month: weekly posts, new photos, questions answered, holiday hours right before anyone asks.",
    promise: "A profile that looks open, current, and busy every single week without you touching it.",
    why: "Google favors profiles that stay active. A polished profile that then sits still slowly slides back down.",
    expectation: "This keeps the profile you fixed working. It is upkeep, and upkeep is what compounds.",
    heroImage: null,
  },
  socialmgmt: {
    id: 'socialmgmt',
    title: "Run your social media",
    tagline: "Posts, stories, comments and DMs, handled",
    description: "Your Instagram and Facebook run month to month: the posts, the stories, the comments, the DMs, and a calendar you approve up front.",
    promise: "A feed that stays alive and an inbox that gets answered, without it living on your phone.",
    why: "People check your feed like they check your hours. A feed that stopped three months ago reads as a place that might be closed.",
    expectation: "Social builds recognition more than it drives tonight's covers. It works best with something worth talking about.",
    heroImage: null,
  },
  pos: {
    id: 'pos',
    title: "Hook up your POS",
    tagline: "Your till tells us what actually sold",
    description: "Your point of sale connected so what sells, who came back, and what a guest is worth stops being a guess.",
    promise: "Your sales and guest history flowing in, so every campaign can be judged on real money.",
    why: "Your till already knows which nights are slow and which dishes carry you. Right now none of that reaches your marketing.",
    expectation: "This is plumbing. It does not bring guests in by itself, it tells you which things did.",
    heroImage: null,
  },
  emaildeliver: {
    id: 'emaildeliver',
