...
const SOURCE = [
  ...
  { id: 'creative', title: 'Request creative work', goal: 'new-customers', stages: ['interest'] },
  ...
  /* NOT built. It is here so it is VISIBLE and honestly labelled rather than silently absent,
   * because most restaurants run their marketing off the POS and an owner looking for it should
