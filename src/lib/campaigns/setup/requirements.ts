...
const FACTS: Requirement[] = [
  ...
  { id: 'PHOTOS', label: 'Thirty or more usable photos', method: 'upload', proof: 'probe', fact: true,
  ...
  { id: 'LINKS', label: 'Your booking and ordering links', method: 'text', proof: 'probe', fact: true,
