...
export const ES: Record<string, string> = {
  ...
  '~{n}% of directions ordered': '~{n}% de los que buscaron cómo llegar pidió',
  'Engaged': 'Miraron más',
  'Revenue': 'Ventas',
  ...
  'Plain words work: try flyer, menu photos, TikTok, Yelp, coupons': 'Escribe normal: prueba volante, fotos del menú, TikTok, Yelp, cupones',
