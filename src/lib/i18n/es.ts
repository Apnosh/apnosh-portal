...
export const ES: Record<string, string> = {
  ...
  'Service style (pick all that apply)': 'Cómo sirves (escoge las que apliquen)',
  'Price point': 'Precio',
  ...
  'Edit': 'Editar',
  "I agree to Apnosh's": 'Acepto los',
  'Terms of Service': 'Términos de servicio',
  'and the': 'y el',
  'Privacy Policy': 'Aviso de privacidad',
  'Complete setup': 'Terminar',
  '{n} total': '{n} en total',
