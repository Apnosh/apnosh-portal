...
export const SOURCES: SourceDef[] = [
  ...
  },
  {
    ...
    provider: 'social',
    stage: 2,
    metricKeys: ['followers_gained'],
    baseStatus: 'CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes: 'Real metric — followers_gained written daily by the social vendor sync (post-attributed follows, or the follower-total diff).',
    wired: true,
  },
  {
    id: 'social_saves_shares',
    displayName: 'Saves and shares',
    provider: 'social',
    stage: 2,
    ...
    authType: 'oauth',
    docsUrl: null,
    notes: 'Real metric — per-post saves + shares folded into the day row raw_data.totals by the vendor sync (2026-08-12). Days synced before then carry 0 here.',
    wired: true,
  },
  {
    id: 'instagram_follows',
    displayName: 'Instagram followers gained',
    provider: 'instagram',
    stage: 2,
    metricKeys: ['followers_gained'],
    baseStatus: 'CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes: 'Real metric — per-platform slice of social_metrics.followers_gained.',
    wired: true,
  },
  {
    id: 'instagram_saves_shares',
    displayName: 'Instagram saves and shares',
    provider: 'instagram',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes: 'Real metric — per-platform saves + shares from the day row raw_data.totals (vendor sync, 2026-08-12 onward).',
    wired: true,
  },
  {
    id: 'facebook_follows',
    displayName: 'Facebook followers gained',
    provider: 'facebook',
    stage: 2,
    metricKeys: ['followers_gained'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'facebook_saves_shares',
    displayName: 'Facebook saves and shares',
    provider: 'facebook',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'tiktok_follows',
    displayName: 'TikTok followers gained',
    provider: 'tiktok',
    stage: 2,
    metricKeys: ['followers_gained'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'tiktok_saves_shares',
    displayName: 'TikTok saves and shares',
    provider: 'tiktok',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'linkedin_follows',
    displayName: 'LinkedIn followers gained',
    provider: 'linkedin',
    stage: 2,
    metricKeys: ['followers_gained'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'linkedin_saves_shares',
    displayName: 'LinkedIn saves and shares',
    provider: 'linkedin',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'youtube_follows',
    displayName: 'YouTube followers gained',
    provider: 'youtube',
    stage: 2,
    metricKeys: ['followers_gained'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'youtube_saves_shares',
    displayName: 'YouTube saves and shares',
    provider: 'youtube',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
  ...
  },
  {
    ...
    docsUrl: null,
    notes:
      'Real metric — likes + comments + saves + shares, written daily into social_metrics.engagement by the social vendor sync. Owner call 2026-08-11: engagement COUNTS into Interest. Split per platform 2026-08-12 (owner ask) — this id keeps its name for continuity but now carries Instagram only; the four siblings carry the rest.',
    wired: true,
  },
  {
    id: 'facebook_engaged',
    ...
    authType: 'oauth',
    docsUrl: null,
    notes: 'Real metric — per-platform slice of social_metrics.engagement (see ig_engaged).',
    wired: true,
  },
  {
    id: 'tiktok_engaged',
    displayName: 'TikTok engagement',
    provider: 'tiktok',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'linkedin_engaged',
    displayName: 'LinkedIn engagement',
    provider: 'linkedin',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'youtube_engaged',
    displayName: 'YouTube engagement',
    provider: 'youtube',
    stage: 2,
    metricKeys: ['engagement'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'ig_likes_comments',
    displayName: 'Instagram likes + comments',
    provider: 'instagram',
    stage: 2,
    metricKeys: ['engagement', 'saves', 'shares'],
    baseStatus: 'CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes:
      'Optional metric (Choose-your-metrics, 2026-08-18): engagement MINUS saves and shares, so enabling it next to the saves+shares metric never double-counts. Hidden and uncounted unless the client turns it on.',
    wired: true,
  },
  {
    id: 'facebook_likes_comments',
    displayName: 'Facebook likes + comments',
    provider: 'facebook',
    stage: 2,
    metricKeys: ['engagement', 'saves', 'shares'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'tiktok_likes_comments',
    displayName: 'TikTok likes + comments',
    provider: 'tiktok',
    stage: 2,
    metricKeys: ['engagement', 'saves', 'shares'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'linkedin_likes_comments',
    displayName: 'LinkedIn likes + comments',
    provider: 'linkedin',
    stage: 2,
    metricKeys: ['engagement', 'saves', 'shares'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'youtube_likes_comments',
    displayName: 'YouTube likes + comments',
    provider: 'youtube',
    stage: 2,
    metricKeys: ['engagement', 'saves', 'shares'],
    baseStatus: 'CONNECTED',
  ...
  {
    id: 'facebook_page_visits',
    displayName: 'People who visited your Facebook page',
    provider: 'facebook',
    stage: 2,
    metricKeys: [],
    baseStatus: 'COMING_SOON',
    authType: 'oauth',
    docsUrl: null,
    notes: NO_ADAPTER_NOTE + ' (Facebook Page views via the Graph API.)',
    wired: false,
  },
  {
    id: 'tiktok_profile_views',
    displayName: 'People who viewed your TikTok profile',
    provider: 'tiktok',
    stage: 2,
    metricKeys: [],
    baseStatus: 'COMING_SOON',
    authType: 'oauth',
    docsUrl: null,
    notes: NO_ADAPTER_NOTE + ' (TikTok profile views via the Business API.)',
    wired: false,
  },
  ...
  {
    id: 'ig_profile_actions',
    displayName: 'Contact taps on your Instagram profile',
    provider: 'instagram',
    stage: 3,
    metricKeys: ['profile_actions', 'website_taps', 'call_taps'],
    baseStatus: 'AVAILABLE_NOT_CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes: IG_MEDIA_NOTE,
  ...
  {
    id: 'facebook_cta_clicks',
    displayName: 'Action taps on your Facebook page',
    provider: 'facebook',
    stage: 3,
    metricKeys: [],
    baseStatus: 'COMING_SOON',
    authType: 'oauth',
    docsUrl: null,
    notes: NO_ADAPTER_NOTE + ' (Facebook Page action-button clicks via the Graph API.)',
    wired: false,
  },
  {
    id: 'tiktok_link_clicks',
    displayName: 'Clicks on your TikTok link',
    provider: 'tiktok',
    stage: 3,
    metricKeys: [],
    baseStatus: 'COMING_SOON',
    authType: 'oauth',
    docsUrl: null,
    notes: NO_ADAPTER_NOTE + ' (TikTok profile link clicks via the Business API.)',
    wired: false,
  },
  ...
  {
    id: 'pos_covers',
    displayName: 'Orders on your register',
    provider: 'pos',
    stage: 4,
    metricKeys: ['orders'],
    baseStatus: 'CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes: 'Real metric — the Square/Clover daily-sales sync writes orders per day into pos_daily_sales. Shows Connect until a register is linked.',
    wired: true,
    isStageNumber: true,
  },
  {
    ...
    provider: 'pos',
    stage: 4,
    metricKeys: ['gross_cents'],
    baseStatus: 'CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes: 'Real metric — gross sales per day from the Square/Clover sync (pos_daily_sales). Shows Connect until a register is linked.',
    wired: true,
  },
  {
    id: 'pos_avg_ticket',
    displayName: 'Average spend per order',
    provider: 'pos',
    stage: 4,
    metricKeys: ['gross_cents', 'orders'],
    baseStatus: 'CONNECTED',
    authType: 'oauth',
    docsUrl: null,
    notes: 'Derived — gross sales divided by orders, from the Square/Clover sync. Shows Connect until a register is linked.',
    wired: true,
    isDrilldown: true,
  },
  {
    ...
    authType: 'manual',
    docsUrl: null,
    notes: 'Real metric — delivery app statements uploaded through the statements lane land in pos_daily_sales (source statement:*). Shows Connect until a statement is uploaded.',
    wired: true,
  },
...
export const SHORT_LABELS: Record<string, string> = {
  ...
  social_follows: 'New followers',
  social_saves_shares: 'Saves and shares',
  instagram_follows: 'New Instagram followers',
  instagram_saves_shares: 'Instagram saves + shares',
  facebook_follows: 'New Facebook followers',
  facebook_saves_shares: 'Facebook saves + shares',
  tiktok_follows: 'New TikTok followers',
  tiktok_saves_shares: 'TikTok saves + shares',
  linkedin_follows: 'New LinkedIn followers',
  linkedin_saves_shares: 'LinkedIn saves + shares',
  youtube_follows: 'New YouTube followers',
  youtube_saves_shares: 'YouTube saves + shares',
  ...
  ig_engaged: 'Instagram engagement',
  facebook_engaged: 'Facebook engagement',
  tiktok_engaged: 'TikTok engagement',
  linkedin_engaged: 'LinkedIn engagement',
  youtube_engaged: 'YouTube engagement',
  ig_saves: 'Post saves',
  ig_shares: 'Post shares',
  ga4_menu_views: 'Menu page views',
  gbp_menu_clicks: 'Menu opens on Google',
  facebook_page_visits: 'Facebook visits',
  tiktok_profile_views: 'TikTok profile views',
  ig_profile_actions: 'Instagram taps',
  facebook_cta_clicks: 'Facebook actions',
  tiktok_link_clicks: 'TikTok link clicks',
  // Stage 3 · Actions
