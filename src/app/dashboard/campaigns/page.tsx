 ...
 * swap"): Plan ahead's layout with the real items. The Week / Month toggle sits in the top row
 * where the bell is elsewhere. Open slots are dashed, yours to fill; tap a piece for its sheet.
 */
...
function Inner() {
  ...
  return (
    <MvpShell active="campaigns" title="Campaigns" solidTop right={toggle}>
