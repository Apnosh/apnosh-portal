...
/**
 * /dashboard/insights — Google Business Profile performance.
 *
 * This is the metrics view that previously lived at /dashboard/analytics.
 * It moved here when /analytics was repurposed into the Plan calendar.
 * The home hero links its channel + activity rows to this page.
 */
    ...
    return (
      <>
        ...
        <div className="hidden lg:block max-w-6xl mx-auto space-y-6">
          <div>
            <h1 className="font-[family-name:var(--font-display)] text-2xl text-ink">Insights</h1>
          ...
          <div className="rounded-2xl bg-white/55 backdrop-blur-xl border border-white/70 p-12 text-center">
            ...
            <p className="text-ink-3 text-sm max-w-md mx-auto">
              Your insights dashboard will show up here once we start tracking your Google Business Profile performance.
            </p>
          </div>
        </div>
      </>
