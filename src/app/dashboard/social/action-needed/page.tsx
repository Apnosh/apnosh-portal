...
import {
  ...
  Image as ImageIcon, Film, RefreshCw, ArrowLeft, X, MessageSquare,
} from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <h1 className="font-[family-name:var(--font-display)] text-2xl text-ink">Action needed</h1>
          <p className="text-ink-3 text-sm mt-0.5">
            Everything waiting for your review, in one place.
          </p>
        </div>
      </div>
