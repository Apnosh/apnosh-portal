  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="font-[family-name:var(--font-display)] text-2xl text-ink">Content Requests</h1>
          <p className="text-ink-3 text-sm mt-1">Request content, review drafts, and track everything in one place.</p>
        </div>
        <Link
