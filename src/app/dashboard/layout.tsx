...
function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  const isFullScreenOwner = pathname === '/dashboard' || pathname.startsWith('/dashboard/campaigns') || pathname === '/dashboard/inbox' || pathname === '/dashboard/messages' || pathname.startsWith('/dashboard/reviews')
