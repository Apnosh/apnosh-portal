...
import { getVendorIncomingBookings } from '@/lib/marketplace/creator-booking'
...
export default async function CreatorBookingsPage() {
  ...
  const bookings = vendor ? await getVendorIncomingBookings() : []
  return <BookingsList initialVendor={vendor ? { name: vendor.name, slug: vendor.slug } : null} initialBookings={bookings} />
}
