...
import {
  ArrowLeft, Check, X, Loader2, MessageSquare, Image as ImageIcon,
...
export default function ClientRequestDetailPage({
  ...
  if (!request) {
    return (
      <div className="max-w-3xl mx-auto py-20 text-center">
        ...
        <Link href={`/client/${slug}/requests`} className="text-brand hover:underline text-sm">
          Back to requests
        </Link>
      </div>
    )
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      {/* Delivered content (if in_review or approved) */}
      {selectedDraft && (
