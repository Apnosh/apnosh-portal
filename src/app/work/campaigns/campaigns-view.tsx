      ...
      <header className="mb-6 flex items-start justify-between gap-3">
        <div>
          <div className="flex items-center gap-3 mb-1.5">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center bg-orange-50 text-orange-700 ring-1 ring-orange-100 flex-shrink-0">
              <Mail className="w-4 h-4" />
            </div>
            <h1 className="text-[22px] sm:text-[24px] leading-tight font-bold text-ink tracking-tight">Campaigns</h1>
          </div>
          <p className="text-[13px] text-ink-2 leading-relaxed max-w-xl ml-10">
