    ...
    <div className="max-w-3xl mx-auto py-7 px-4 lg:px-6">
      <header className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-teal-50 text-teal-700 ring-1 ring-teal-100">
        ...
        <p className="text-[13px] text-ink-2 mt-1.5 leading-relaxed max-w-2xl">
          Comments and DMs across your assigned clients. AI drafts a reply grounded in each client&rsquo;s voice. You approve, edit, or write your own.
        </p>
      </header>
