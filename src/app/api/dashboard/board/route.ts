...
export interface NeedItem { id: string; kind: 'approve' | 'see' | 'pay' | 'there' | 'fill' | 'reconnect' | 'task'; title: string; detail: string; action: string | null; href: string; when: string | null; slotId?: string; slotKind?: string; slotDate?: string }
