...
const CATALOG = [
  ...
  { id: "measure", type: "task", icon: "chart", title: "Get measurable", sub: "See where your customers come from, and what they do", cad: "once" },
  { id: "emaildeliver", type: "task", icon: "mail", title: "Land in the inbox", sub: "Stop your email going to spam before you send any", cad: "once" },
  { id: "deliverymenu", type: "task", icon: "bag", title: "Price your delivery menu", sub: "Stop losing money on every delivery order", cad: "once" },
...
const PICK = {
  ...
  gpost: "listing", gbp: "listing", listings: "listing", socialprofiles: "social", measure: "site", emaildeliver: "email", deliverymenu: "ordering", localseo: "map", website: "ordering",
...
// The "Get listed everywhere" card's lanes. This one carries BOTH prices because the service
// really is both: a one-time cleanup and then keeping it that way. Showing only the setup fee
// would surprise them on the second invoice.
const LIST_DOER_SELF = "done by you yourself, step by step, free";
const LIST_DOER_AI = "done with Apnosh AI, step by step, free";
const LIST_DOER_APNOSH = `done for you by Apnosh, $${(ITEM_PRICES.listings && ITEM_PRICES.listings.oneTime) || 195} then $${(ITEM_PRICES.listings && ITEM_PRICES.listings.perMonth) || 115} a month`;
...
const QL = {
  ...
  listings: { lead: "Get {where} listed and synced, {doer}.", slots: { where: { k: "multi", v: ["Yelp", "Apple Maps"], o: ["Yelp", "Apple Maps", "Bing", "TripAdvisor", "Facebook"] }, doer: { k: "pick", label: "Who does it", v: LIST_DOER_APNOSH, o: [LIST_DOER_SELF, LIST_DOER_AI, LIST_DOER_APNOSH] } } },
