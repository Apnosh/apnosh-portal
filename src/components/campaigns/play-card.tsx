...
import { Search, Wrench, Mail, UtensilsCrossed, Heart, Repeat, RotateCcw, Star, CalendarClock, ChevronRight } from 'lucide-react'
...
const STAGE_ICON: Record<string, typeof Search> = {
  foundation: Wrench, awareness: Search, capture: Mail, convert: UtensilsCrossed,
  nurture: Heart, retain: Repeat, winback: RotateCcw, advocate: Star, anticipation: CalendarClock,
}
...
export default function PlayCard({
  ...
  const Icon = STAGE_ICON[play.key] ?? Star
