...
/**
 * Two compact rails surfaced above the task buckets on /admin/today:
 *
 *   1. Sent quotes awaiting client response — count + the 5 oldest.
 *      So the strategist can chase clients who haven't decided yet.
 *   2. Pending boost requests — count + the 5 oldest.
 *      So the strategist sees ad work to launch in Meta Ads Manager.
 *
 * Both rails hide when empty.
 */

import { useEffect, useState } from 'react'
import Link from 'next/link'
import { FileText, Zap, ArrowRight, Clock } from 'lucide-react'
...
export default function StrategistRails() {
  ...
  if (!hasQuotes && !hasBoosts) return null
