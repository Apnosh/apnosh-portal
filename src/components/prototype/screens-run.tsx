  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Card C={C} style={{ padding: '18px 6px 14px' }}>
        <Crowd C={C} steps={o.steps} leak={o.leak} goal={40} height={320} />
        <div style={{
        ...
        <div style={{
          ...
          Thickness is people. The mouth is reach and is drawn off-scale, because 2,720
          impressions and 12 covers cannot share an axis. Everything after it is one person per
          pixel, so each band that peels off the top is exactly how many you lost.
        </div>
      </Card>
